                ...
                <div class="">
                    <ul>
                        @foreach ($errors->all() as $error)
                            <li class="bg-red-400 text-white p-2 m-2">{{ $error }}</li>
                        @endforeach
                    </ul>
                </div>
            @endif
            <form action="{{route('add-user-action')}}" method="POST" class="mt-5">
                @csrf
                <div class="lg:flex xl:flex">
                    <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 m-2">
                        <label for="user_name" class="block">Name</label>
                        <input type="text" class="w-full py-2 mt-2 border-2 border-gray-200 rounded px-2" name="name" id="name" placeholder="Enter your name">
                    </div>
                    <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 m-2">
                        <label for="email" class="block">Email</label>
                        <input type="text" class="w-full py-2 mt-2 border-2 border-gray-200 rounded px-2" name="email" id="email" placeholder="example@gmail.com">
                    </div>
                </div>
                <div class="lg:flex xl:flex">
                    <div class="sm:w-full md:w-full lg:w-full xl:w-full m-2">
                        <label for="phone" class="block">Phone</label>
                        <input type="text" class="w-full py-2 mt-2 border-2 border-gray-200 rounded px-2" name="phone" id="phone" placeholder="Enter your name">
                    </div>
                ...
                <div class="lg:flex xl:flex">
                    <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 m-2">
                        ...
                        <input type="password" class="w-full py-2 mt-2 border-2 border-gray-200 rounded px-2" name="password" id="name" placeholder="***********">
                    </div>
                    <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 m-2">
                        <label for="email" class="block">Confirm password</label>
                        <input type="password" class="w-full py-2 mt-2 border-2 border-gray-200 rounded px-2" name="password_confirmation" id="password_confirmation" placeholder="***********">
                    </div>
                </div>
