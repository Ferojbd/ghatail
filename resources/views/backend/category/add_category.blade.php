            ...
            <div class="flex">
             ...
             <div class="shadow-xl form-c mt-4">
                           <form action="{{route('category-action')}}" method="POST" class="">
                               @csrf
                               <div class="">
                                   <input type="text" class="w-full mr-1  p-1 mb-2 border-2 border-gray-300 rounded" name="category" id="category" placeholder="Add new name">
                                        @if ($category->count() > 0)
                                                <select  name="parent_id" class="p-1 mt-2 w-full border-2 border-gray-200 rounded">
