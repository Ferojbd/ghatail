      ...
      <section class="md:w-full lg:w-full xl:w-full">
         <div class="bg-gray-800 pt-3">
                <div class=" bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                    <h3 class="font-bold pl-2">TRUSH</h3>
                </div>
            </div>
       <div class="p-5 m-5 bg-white text-gray-700 shadow-lg">
            <div class="flex">
               <div class="w-2/4">
                   <h1 class="font-bold text-2xl">ALL NEWS IN TRUSH</h1>
               </div>
                            ...
                            @if ($news)
                                @foreach($news as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                                <img class="h-10 w-10 rounded-full" src="{{asset('/uploads/news/'.$item->news_img)}}" alt="">  
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    {{-- @can('isAdmin', Auth::user())                                        --}}
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-left">
                                            ...
                                            <a href="{{route('recycle-news', $item->id)}}" class="text-green-600 hover:text-indigo-900"><i class="fas fa-recycle"></i></a>
                                            <a href="{{route('delete-trash', $item->id)}}" class="text-red-600 hover:text-indigo-900"><i class="fas fa-trash"></i></a>
                                        </td>
                                    {{-- @endcan    --}}
